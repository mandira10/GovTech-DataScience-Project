...
from sklearn.metrics import accuracy_score, make_scorer, precision_score, recall_score, f1_score,  classification_report, plot_confusion_matrix
...
# Define the resampling and classification pipeline with SMOTE and LightGBM
pipeline = Pipeline([
